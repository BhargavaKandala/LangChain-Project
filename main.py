...
animal_type = st.sidebar.selectbox("What is your pet?", ("Cat", "Dog", "Chick", "Cow", "Hamster"))
...
if animal_type == "Chick":
    pet_color = st.sidebar.text_area(label="What color is your chick?", max_chars=15)
